...
balance = {
    ...
    "2k":[
        "You can buy lots of coffee ☕ with this, {name}. Here's your balance: {balance} Tk",
        "Buy whatever you want {name}. You have {balance} Tk. in your balance",
        "Good day {name} 😊! Here's your balance: {balance} Tk."
    ],
    "1k":[
        "Buy whatever you want {name}. You have {balance} Tk. in your balance",
        "Good day {name} 😊! Here's your balance: {balance} Tk."
    ...
    "100":[
        "You understand it's not dollars, right 😒? Anways, here's your balance: {balance} Tk.",
        "Well, the tong isn't that far. So I guess it's okay having {balance} Tk. in your balance {name}",
        "When life gives you lemon 🍋 you gotta make lemonade 🍹. You have to do something like that with your {balance} Tk. balance {name}",
        "Oh I wish I could give you some money, {name}. Your balance is {balance} Tk.",
        "You should add fund, {name}. You only have {balance} Tk. in your balance",
        "Ugh! I hate it when broke people ask me to check balance 😤. Here's your balance 😒 {name}: {balance} Tk."
    ],
    ">0":[
        "You understand it's not dollars, right 😒? Anways, here's your balance: {balance} Tk.",
        "Well, the tong isn't that far. So I guess it's okay having {balance} Tk. in your balance {name}",
        ...
        "You should add fund, {name}. You only have {balance} Tk. in your balance",
        "Ugh! I hate it when broke people ask me to check balance 😤. Here's your balance 😒 {name}: {balance} Tk.",
        "You can't even afford a coffee {name} 😒. Here's your balance: {balance} Tk."
    ],
    "0":[
        "Who invented the number 0 🤔?\n\n{name}'s bank balance 🤣",
        "You're almost a billionair {name} 🤯!\n\nYou're only a billion dollar short 🤣",
        "You ran out of money {name} 😨!. You're balance is 0 Tk.",
        "Good day Aryabhatta! Your balance is your favourite number: 0",
        "Oh you poor little {name} 🥺. Your balance is 0 Tk.",
        "If you double your balance, it stays the same. Guess what your balance is {name}",
        "Your balance isn't hard to remember {name}. It's 0 Tk. 🤣"
    ],
    "<0":[
        "Damm {name}! You're like reverse Bruce Wayne.\n\nNo, you're not Batman, you're poor. Here's your balance: {balance} Tk.",
        "Oh you poor little {name} 🥺! You're now in debt. This is your balance: {balance} Tk.",
        "Umm, do you need help cleaning those dishes {name}? Your balance is {balance} Tk.",
        "Ugh! I hate it when broke people ask me to check balance 😤. Here's your balance 😒 {name}: {balance} Tk."
    ]
}